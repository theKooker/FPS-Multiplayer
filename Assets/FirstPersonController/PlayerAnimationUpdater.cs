...
public class PlayerAnimationUpdater : NetworkBehaviour
{// TODO fix: https://github.com/Unity-Technologies/com.unity.netcode.gameobjects/issues/2305
    ...
    private void UpdateAnimator() {
        Vector3 localVelocity = Quaternion.Inverse(transform.rotation) * playerMovement.Velocity;
        ...
        // Speed Value
        float speedChange = (planeVelocity.magnitude/playerMovement.MaxSpeed - _animatorSpeed) * Time.deltaTime;
        ...
        // Crouch Value
        _animator.SetFloat(ANIM_CROUCH, playerMovement.Crouched);
        Debug.DrawRay(transform.position, transform.forward, Color.red);

        _animator.SetBool(ANIM_GROUNDED, playerMovement.Grounded);
    }
